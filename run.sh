...
--audio_dir=/home/jxl220096/data/llp/feats/vggish/ --audio_enc=1 --audio_smoothing=1 --aug_type=ada \
...
--num_layer=1 --occ_dim=128 --prob_drop=0.4 --prob_drop_occ=0.25 --st_dir=/home/jxl220096/data/llp/feats/r2plus1d_18/ --tmp=1 --tsne=0 \
--video_dir=/home/jxl220096/data/llp/feats/res152/ --vis_smoothing=1 --early_stop=10 --gpu 0 \
